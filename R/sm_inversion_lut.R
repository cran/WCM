#' Inversion of SM from look up table generated by WCM Title
#'
#' @param img raster object
#' @param lookuptable Look up table simulated from 'wcm_sim' function
#'
#' @return a raster object (pixel value represnts SM)
#' @export
#'
#' @examples
#' scatsat1 <- raster::raster(ncol=10, nrow=10)
...
#' C= -11.758309
#' D=  0.011344
#' lut1 <- lut_wcm(LAI=seq(1,6,0.1), SM=seq(0,.6,.1),coeff=c(A,B,C,D))
#' \donttest{out_sm <- sm_inversion_lut(img = scatsat1,lookuptable = lut1)}
